...
def parse(line: str, in_multiline: bool = False) -> typing.List[CodeBlock]:
...
def is_in_block(link_start: int, code_blocks: typing.List[CodeBlock]) -> bool:
    if (
        not code_blocks or
